close all;
clear all;clc;
PathName = 'C:\Users\ONI\Desktop\LatestIrisRecog\IRIS_CL\black_iris_images\all_image\left_iris\';

for iris = 1:20;
    for iris1 = 1:6;
    img_filename = strcat(PathName,num2str(iris),'LI_',num2str(iris1),'.jpg')
    ...
    cd('C:\Users\ONI\Desktop\LatestIrisRecog\IRIS_CL\black_iris_images\all_image\left_iris\templates\')
    imwrite(template, strcat('a',num2str(iris),'LI_',num2str(iris1),'.jpg'),'jpg');
    imwrite(mask,strcat('b',num2str(iris),'LI_',num2str(iris1),'.jpg'),'jpg');
    template1 = imread(strcat('a',num2str(iris),'LI_',num2str(iris1),'.jpg'));
    mask1 = imread(strcat('b',num2str(iris),'LI_',num2str(iris1),'.jpg'));
